    ...
    <div className="flex flex-col w-full">
      <div className="lg:flex lg:flex-row md:flex-row md:flex sm:flex sm:flex-col-reverse sm:items-center w-full">
        <div className="h-full p-2.5 w-full flex flex-col gap-2.5 justify-between border-r border-r-gray-100">
          ...
          <KeyValue
            title="Nom"
            value={transaction?.wallet?.user?.username ?? ''}
          />
          <KeyValue
            title="Email"
          ...
          <KeyValue
            title="Adresse"
            value={
              transaction?.wallet?.user?.address?.country +
                ' ' +
                transaction.wallet?.user.address?.secondAdress +
                ' ' +
                transaction.wallet?.user.address?.zipCode ?? ''
            }
          />
        </div>
