...
import { deleteTransaction, editTransaction } from 'services/redux/transaction';
...
export default function TransactionTable() {
  ...
  const { transactionList } = useAppSelector((state) => state.transaction);
              ...
              {visibleRows.map((row: TransactionDTO, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>
                      {moment(String(row.date)).format('DD/MM/YYYY')}
                    </TableCell>
                    <TableCell>
