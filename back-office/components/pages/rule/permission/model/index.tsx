...
import AvalaiblePermissionTable from './AvalaibleModelTable';
import SelectedPermissionTable from './SelectedModelTable';
import { MuiContainedButton, MuiIconButton } from './styles';

export default function ModelInRuleComponent() {
    ...
    <div className="bg-white h-full pb-2.5 w-full">
      <div className="flex items-center justify-between border-b border-b-gray-100 pr-2.5">
        ...
        <MuiContainedButton
          ...
          onClick={() => dispatch(toggleModelInsideRule(false))}
        >
          Retour
        </MuiContainedButton>
      </div>
