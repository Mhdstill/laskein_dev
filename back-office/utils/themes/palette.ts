...
const PRIMARY = {
  lighter: lighten(0.2, '#2F435E'),
  light: lighten(0.3, '#2F435E'),
  main: '#2F435E',
  dark: darken(0.3, '#2F435E'),
  darker: darken(0.2, '#2F435E'),
  contrastText: '#fff',
};

const SECONDARY = {
  lighter: lighten(0.2, '#376F70'),
  light: lighten(0.3, '#376F70'),
  main: '#376F70',
  dark: darken(0.3, '#376F70'),
  darker: darken(0.2, '#376F70'),
  contrastText: '#fff',
};

const INFO = {
  lighter: lighten(0.2, '#1976D2'),
  light: lighten(0.3, '#1976D2'),
  main: '#1976D2',
  dark: darken(0.3, '#1976D2'),
  darker: darken(0.2, '#1976D2'),
  contrastText: '#fff',
};
...
const ERROR = {
  lighter: lighten(0.2, '#C62828'),
  light: lighten(0.3, '#C62828'),
  main: '#C62828',
  dark: darken(0.3, '#C62828'),
  darker: darken(0.2, '#C62828'),
  contrastText: '#fff',
};
/**
...
const GRAY = {
  lighter: lighten(0.2, 'rgba(0, 0, 0, 0.26)'),
  light: lighten(0.3, 'rgba(0, 0, 0, 0.26)'),
  main: 'rgba(0, 0, 0, 0.26)',
  dark: darken(0.3, 'rgba(0, 0, 0, 0.26)'),
  darker: darken(0.2, 'rgba(0, 0, 0, 0.26)'),
  contrastText: '#fff',
};
